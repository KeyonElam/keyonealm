      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Keyon Elam </span>
            from <span className="purple"> Miami, Florida, US.</span>
            <br />
          ...
          <footer className="blockquote-footer">Keyon Elam</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
